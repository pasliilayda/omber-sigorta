    ...
    <main className="min-h-screen bg-white px-6 py-20 md:px-20">
      <article className="mx-auto max-w-4xl">
        ...
        <p className="mt-8 text-lg leading-8 text-[#4d5b6b]">
          Taşımacılık sürecinde ürünleriniz yalnızca varış noktasına gitmez; yol
          boyunca birçok riske de maruz kalır. Navlun sigortası bu risklere
        ...
        <div className="mt-12 space-y-10 text-lg leading-9 text-[#4d5b6b]">
          ...
          <section>
            ...
            <p className="mt-4">
              Taşıma zincirinde ürünlerin kaybolması, eksik teslim edilmesi veya
              yanlış yönlendirilmesi gibi durumlar ticari zararlara yol
              açabilir.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              yaratmaz; müşteri ilişkilerini ve ticari güveni de etkileyebilir.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              Navlun sigortasında yükün türü, taşıma şekli, rota ve ürün değeri
              dikkate alınmalıdır. Bu yüzden standart değil, ihtiyaca uygun
              poliçe seçimi yapılmalıdır.
            </p>
          </section>
        </div>
