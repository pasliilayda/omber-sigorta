          ...
          <div className="mt-12 space-y-10 text-lg leading-9 text-[#4d5b6b]">
            <section>
              ...
              <p className="mt-4">
                ...
                tesisat problemleri ve doğal afet kaynaklı zararlar bulunur.
                Konut sigortası bu risklere karşı finansal koruma sağlayabilir.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">
                Konut sigortası yalnızca bina için düşünülmemelidir. Kiracılar
                da eşyalarını ve yaşam alanlarını güvence altına almak için
                uygun poliçe seçeneklerini değerlendirebilir.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">
                ...
                maliyetle koruma sağlar. Bu nedenle uzun vadede önemli bir
                güvence aracıdır.
              </p>
            </section>
          </div>
