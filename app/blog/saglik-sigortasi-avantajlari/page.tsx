      ...
      <main className="min-h-screen bg-white px-6 py-20 md:px-20">
        <article className="mx-auto max-w-4xl">
          ...
          <p className="mt-8 text-lg leading-8 text-[#4d5b6b]">
            Sağlık sigortası yalnızca hastalık anında değil, uzun vadeli
            finansal planlama açısından da önemli bir güvence sağlayabilir.
          </p>
          ...
          <div className="mt-12 space-y-10 text-lg leading-9 text-[#4d5b6b]">
            ...
            <section>
              ...
              <p className="mt-4">
                Sağlık giderleri beklenmedik şekilde ortaya çıkabilir. Sigorta,
                bu giderleri daha yönetilebilir hale getirerek bütçe
            ...
            <section>
              ...
              <p className="mt-4">
                ...
                güven sağlar. Sağlığınızla ilgili riskleri daha rahat
