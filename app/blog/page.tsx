...
const posts = [
  {
    category: "Kasko",
    title: "KKTC’de Kasko Zorunlu mu?",
    desc: "Kasko sigortası zorunlu mu, trafik sigortasından farkı ne ve neden önemli?",
    href: "/blog/kktc-kasko-zorunlu-mu",
    read: "4 dk",
  },
  {
    category: "Trafik Sigortası",
    title: "Trafik Sigortası Neleri Karşılar?",
    desc: "KKTC’de trafik sigortasının kapsamı, amacı ve sürücüler için önemi.",
    href: "/blog/trafik-sigortasi-neleri-karsilar",
    read: "5 dk",
  },
  {
    category: "Navlun",
    title: "Navlun Sigortası Nedir?",
    desc: "Taşımacılıkta yüklerinizi güvence altına alan navlun sigortası hakkında rehber.",
    href: "/blog/navlun-sigortasi-nedir",
    read: "5 dk",
  },
  {
    category: "Konut",
    title: "Konut Sigortası Neden Önemlidir?",
    desc: "Ev sahipleri ve kiracılar için konut sigortasının sunduğu avantajlar.",
    href: "/blog/konut-sigortasi-neden-onemlidir",
    read: "4 dk",
  },
  {
    category: "Sağlık",
    title: "Sağlık Sigortası Neleri Kapsar?",
    desc: "Sağlık sigortası kapsamları, dikkat edilmesi gerekenler ve teklif alma süreci.",
    href: "/blog/saglik-sigortasi-neleri-kapsar",
    read: "4 dk",
  },
  {
    category: "Genel",
    title: "KKTC’de Sigorta Teklifi Nasıl Alınır?",
    desc: "Sigorta teklifi alırken hangi bilgiler gerekir ve doğru poliçe nasıl seçilir?",
    href: "/blog/kktc-sigorta-teklifi-nasil-alinir",
    read: "5 dk",
  },
];
