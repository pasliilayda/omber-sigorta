      ...
      <main className="min-h-screen bg-white px-6 py-20 md:px-20">
        <article className="mx-auto max-w-4xl">
          ...
          <p className="mt-8 text-lg leading-8 text-[#4d5b6b]">
            Kaza sonrası yapılan bazı hatalar hem sigorta sürecini
            zorlaştırabilir hem de maddi kayıplara neden olabilir.
          </p>
          ...
          <div className="mt-12 space-y-10 text-lg leading-9 text-[#4d5b6b]">
            ...
            <section>
              ...
              <p className="mt-4">
                Kaza sonrası süreci hızlı başlatmak önemlidir. Geciken
                bildirimler bazı durumlarda sorun oluşturabilir.
              </p>
            </section>
          ...
          <div className="mt-16 rounded-3xl bg-[#071f3d] p-10 text-white">
            ...
            <p className="mt-4 max-w-2xl text-white/80">
              Omber Sigorta ile ihtiyaçlarınıza uygun sigorta çözümlerini
