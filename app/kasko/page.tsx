export const metadata = {
  title: "KKTC Kasko Sigortası | Omber Sigorta",
  description:
    "KKTC’de uygun fiyatlı kasko sigortası teklifleri. Aracınızı kazalara, doğal afetlere ve risklere karşı güvence altına alın.",
};
    ...
    <main className="min-h-screen bg-white px-6 py-20 md:px-20">
      <div className="mx-auto max-w-5xl">
        ...
        <h1 className="mt-6 text-4xl font-black leading-tight text-[#071f3d] md:text-6xl">
          KKTC Kasko Sigortası
        </h1>

        <p className="mt-8 text-lg leading-8 text-[#4d5b6b]">
          Omber Sigorta olarak KKTC’de aracınızı güvence altına alan profesyonel
          kasko sigortası çözümleri sunuyoruz.
        </p>
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-2">
          <div className="rounded-3xl border border-[#e7edf3] p-8 shadow-sm">
            ...
            <ul className="mt-6 space-y-4 text-[#4d5b6b]">
              <li>• Çarpma ve çarpışma hasarları</li>
              <li>• Hırsızlık ve hırsızlığa teşebbüs</li>
              <li>• Yangın hasarları</li>
              <li>• Doğal afet kaynaklı zararlar</li>
              <li>• Cam kırılması</li>
              <li>• Üçüncü kişilerin verdiği zararlar</li>
            </ul>
          </div>
        ...
        <div className="mt-16 rounded-3xl bg-[#071f3d] p-10 text-white">
          <h2 className="text-3xl font-black">Hemen Kasko Teklifi Alın</h2>

          <p className="mt-4 max-w-2xl text-white/80">
            Aracınıza en uygun kasko tekliflerini hızlıca öğrenmek için bizimle
            iletişime geçin.
          </p>
